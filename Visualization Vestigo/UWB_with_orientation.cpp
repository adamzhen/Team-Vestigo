    ...
    while (!quit) {
        ...
        ******** Data ********/
        ...
        if (recvLen_1 <= 0) {
            ...
            UWB_x = (point_1_prime(0) + point_2_prime(0) + point_3_prime(0) + point_4_prime(0)) / 4;
            UWB_y = (point_1_prime(1) + point_2_prime(1) + point_3_prime(1) + point_4_prime(1)) / 4;
            UWB_z = (point_1_prime(2) + point_2_prime(2) + point_3_prime(2) + point_4_prime(2)) / 4;
        }
        else {
