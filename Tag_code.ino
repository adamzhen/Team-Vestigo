...
// Wifi creds
const char *AP_SSID = "FREE WIFI NO MALWARE";
const char *AP_PWD = "Playadel2005?";
WiFiMulti wifiMulti;
...
void loop() 
{
  ...
  JsonArray distance_1 = doc.to<JsonArray>();
  for (int i = 0; i < distance_1_data.size(); i++){
    distance_1.add(distance_1_data[i]);
  }
  JsonArray distance_2 = doc.to<JsonArray>();
  for (int i = 0; i < distance_2_data.size(); i++){
    distance_2.add(distance_2_data[i]);
  }
  JsonArray distance_3 = doc.to<JsonArray>();
  for (int i = 0; i < distance_3_data.size(); i++){
    distance_3.add(distance_3_data[i]);
  }
  JsonArray distance_4 = doc.to<JsonArray>();
  for (int i = 0; i < distance_4_data.size(); i++){
    distance_4.add(distance_4_data[i]);
  }
  
  doc["Distance 1"] = distance_1;
  doc["Distance 2"] = distance_2;
  doc["Distance 3"] = distance_3;
  doc["Distance 4"] = distance_4;
  ...
  if (wifiMulti.run() == WL_CONNECTED) {
    ...
    for (int i = 0; i < distance_1_data.size(); i++){
      Serial.print(distance_1_data[i]);
      Serial.print(", ");
    }
    Serial.println("");
    Serial.print("Distance 2: ");
    for (int i = 0; i < distance_2_data.size(); i++){
      Serial.print(distance_2_data[i]);
      Serial.print(", ");
    }
    Serial.println("");
    Serial.print("Distance 3: ");
    for (int i = 0; i < distance_3_data.size(); i++){
      Serial.print(distance_3_data[i]);
      Serial.print(", ");
    }
    Serial.println("");
    Serial.print("Distance 4: ");
    for (int i = 0; i < distance_4_data.size(); i++){
      Serial.print(distance_4_data[i]);
      Serial.print(", ");
    }
    Serial.println("");
    ...
    http.begin("http://10.229.229.126");  
