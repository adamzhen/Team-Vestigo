...
void loop()
{
  ...
  if ((myICM.status == ICM_20948_Stat_Ok) || (myICM.status == ICM_20948_Stat_FIFOMoreDataAvail)) // Was valid data available?
  {
    ...
    if ((data.header & DMP_header_bitmap_Quat9) > 0) // We have asked for orientation data so we should receive Quat9
    {
      ...
      double acc = ((double)data.Quat9.Data.Accuracy) / 1073741824.0; // Convert to double. Divide by 2^30
      double q0 = 1.0;
      //SERIAL_PORT.printf("Quat9 data is: Q1:%f Q2:%f Q3:%f Accuracy:%f\r\n", q1, q2, q3, acc);
      ...
      double acc = ((double)data.Quat9.Data.Accuracy) / 1073741824.0; // Convert to double. Divide by 2^30
      double q0 = 1.0;
      SERIAL_PORT.printf("Quat9 data is: Q1:%f Q2:%f Q3:%f Val:%f\r\n", q1, q2, q3, ((q1 * q1) + (q2 * q2) + (q3 * q3)));
#endif
    }
  } else {
