...
const String channelID   = "2095519"; // Change this to your channel ID
const String writeApiKey = "7Y03HBYLGA5Z9FG0"; // Change this to your Write API key
const String readApiKey = "KL27GVV3T9SSOCQM"; // Change this to your Read API key
