#ifndef KALMAN_EXAMPLES_Vestigo_POSITIONMEASUREMENTMODEL_HPP_
#define KALMAN_EXAMPLES_Vestigo_POSITIONMEASUREMENTMODEL_HPP_
...
public:
    ...
    typedef  KalmanExamples::Vestigo::PositionMeasurement<T> M;
...
protected:
    //! Position from UWB given as (x,y)-measurement
    Kalman::Vector<T, 2> UWBpos;
